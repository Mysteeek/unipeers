...
import { schools } from "@/assets/local_data/school-list";
import { db } from "@/config/firebase.config";
import { themeColors } from "@/utils/theme.utils";
import { useLocalSearchParams } from "expo-router"; // import to get id of event
...
export default function UpdateEvent () {
    ...
    // perform getDoc and set to useState
    useEffect(() => {
      if (!uid) return;
    ...
    const handleUpdateEvent = async () => {
      ...
      try {
        ...
        Alert.alert("✅ Success", "Your event was successfully updated");
      } catch (error) {
